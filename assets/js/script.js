$(document).ready(function () {
    ...
    //most recently searched city function
    ...
    function search() {
        ...
        $.ajax({
            ...
            getWeather(response.coordinates.lat, response.coordinates.lon);
        }).fail(function () {
            alert("Could not get data")
        });

        //function to get 5-day forecast and UV to display 
